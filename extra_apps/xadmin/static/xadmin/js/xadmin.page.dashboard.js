jQuery(function() {
  $( ".btn-quick-form" ).click(function(){
    ...
    if(!btn.data('form-modal')){
      var modal = $('<div class="modal hide fade quick-form" group="dialog"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h3>'+ 
