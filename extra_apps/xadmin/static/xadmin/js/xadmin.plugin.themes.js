  ...
  $(function(){
    ...
    if($("#g-theme-menu")){
      $('#g-theme-menu li>a').click(function(){
        ...
        var modal = $('<div id="load-theme-modal" class="modal fade" group="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4>'+ 
