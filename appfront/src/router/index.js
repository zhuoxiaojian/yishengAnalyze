  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/appfront/Demo/BaseChartInfo',
          component: resolve=> require(['@/components/Frame/Demo/BaseChartInfo'], resolve),
          name: '报表管理',
          menuShow: true,
          meta: {requireAuth: true,},
        ...
        {
          path: '/appfront/Demo/MarkDownInfo',
          component: resolve=> require(['@/components/Frame/Demo/MarkDownInfo'], resolve),
          name: 'MarkDown',
          menuShow: true,
          meta: {requireAuth: true,},
        ...
        },
        {
          ...
          component: resolve=> require(['@/components/Frame/Demo/VueEditorInfo'], resolve),
          name: 'VueEditor',
          menuShow: true,
          meta: {requireAuth: true,},
